...
export default function AllAssetClassification() {
    ...
    const [deleteAssetClassification, { isLoading: isDeleteLoading }] =
        useDeleteAssetClassificationMutation();
    ...
    const onUpdate = (item: any) => {
        dispatch(
            openDialog({
                type: DialogType.AddAssetClassification,
                dialogProps: {
                    header: "Update Asset Classification",
                    data: item,
                    type: "update",
                },
            })
                    ...
                    onClick={() =>
                        dispatch(
                            openDialog({
                                type: DialogType.AddAssetClassification,
                                dialogProps: {
                                    header: "Add Asset Classification",
                                },
                            })
                        )
                    }
